...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     */
    public FfmpegLibraryAccessors getFfmpeg() { return laccForFfmpegLibraryAccessors; }
    ...
    public static class FfmpegLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public FfmpegKitLibraryAccessors getKit() { return laccForFfmpegKitLibraryAccessors; }
    ...
    public static class FfmpegKitLibraryAccessors extends SubDependencyFactory {
        ...
        public FfmpegKitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for full (com.arthenica:ffmpeg-kit-min)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getFull() { return create("ffmpeg.kit.full"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: activity (1.4.0)
            ...
            /**
             * Returns the version associated to this alias: agp (7.1.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: constraintlayout (1.1.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: ffmpegKitFull (6.0.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
